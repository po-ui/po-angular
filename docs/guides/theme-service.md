  ...
  type: [
    {
      light: {
        ...
        onRoot: {
          ...
          '--po-density-content-padding': '1rem'; /* Padding em contents (inclui pages, container, list view, page slide, stepper, disclaimer-group) */
...
:root .override-theme {
  ...
  --po-density-content-padding: 1rem; /* Padding interno em contents (inclui pages, dynamics, container, list view, page slide, stepper e disclaimer-group) */
