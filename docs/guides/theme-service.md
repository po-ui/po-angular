  ...
  type: [
    {
      light: {
        ...
        onRoot: {
          ...
          '--po-density-block-spacing': '1rem'; /* Espaço interno entre o header e o content (inclui pages, tabs e stepper) */
          '--po-density-gap-header-content': '1rem'; /* Espaço interno entre blocos de conteúdo do header e content (inclui dividers e gaps) */
        },
        perComponent: {
          'po-button': {
