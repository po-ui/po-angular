...
export default tseslint.config(
  ...
  },
  {
    ...
    languageOptions: {
      parserOptions: {
        // Usa o Project Service do typescript-eslint (v8+) em vez de listar
        // manualmente todos os tsconfigs. O Project Service resolve o tsconfig
        // correto por arquivo sob demanda e reaproveita Programs, reduzindo
        // drasticamente o consumo de memoria (evita OOM ao manter 14 Programs
        // TypeScript vivos ao mesmo tempo).
        projectService: true,
  ...
  // Com o Project Service habilitado no bloco base, a associacao arquivo ->
  // tsconfig e resolvida automaticamente (inclusive para os tsconfigs de
  // schematics). Por isso nao e mais necessario declarar `project` aqui; fazer
  // isso gera erro "Enabling 'project' does nothing when 'projectService' is
  // enabled". Os blocos abaixo permanecem apenas como marcadores/documentacao
  // do escopo, sem override de parserOptions.
