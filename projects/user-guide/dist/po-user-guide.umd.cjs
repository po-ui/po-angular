...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.PoUserGuide = {}));
  ...
  exports.PoUserGuide = PoUserGuide;

}));
//# sourceMappingURL=po-user-guide.umd.cjs.map
