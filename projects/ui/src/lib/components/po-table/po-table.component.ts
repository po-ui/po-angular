  ...
  implements AfterViewChecked, AfterViewInit, DoCheck, OnDestroy, OnInit
{
  ...
  constructor(
    ...
    // Ao remover este listener, no portal, quando as colunas forem fixas não sofrem
  ...
  private expandDataColumnWidthsForFullDataset(
    ...
    dataIndexes.forEach((cellIndex, dataColumnIndex) => {
      ...
      const contentEl = (cell.querySelector('.po-table-column-cell') as HTMLElement) ?? cell;
