...
describe('PoTableColumnIconComponent:', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PoTableColumnIconComponent],
  ...
  describe('Methods:', () => {
    ...
    it('getColor: should call `color` function and return string color.', () => {
      ...
      vi.spyOn(fakeColumn, 'color').mockReturnValue('color-08');
    ...
    it('click: shouldn`t call columnIcon.action or column.action neither `stopPropagation` if columnIcon.disabled is true', () => {
      ...
      vi.spyOn(component, 'isDisabled');
      vi.spyOn(fakeColumnIcon, 'action');
      vi.spyOn(component.column, 'action');
