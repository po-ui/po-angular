...
describe('PoTableBaseComponent:', () => {
  ...
  it('should call setColumnLink when set columns', () => {
    vi.spyOn(component as any, 'setColumnLink').mockImplementation(() => {});
  ...
  it('validate if action can be called', () => {
    ...
    vi.spyOn(tableAction, 'action' as any).mockImplementation(() => {});
  ...
  it('validate if disabled action can be called', () => {
    ...
    vi.spyOn(tableDisabledAction, 'disabled' as any).mockImplementation(() => {});
  ...
  it('should toggle sort descending and ascending', () => {
    ...
    const spy = vi.spyOn(component as any, 'sortArray');
    component.sortColumn(column);
    expect(spy).toHaveBeenCalledWith(column, true);

    component.sortColumn(column);
    expect(spy).toHaveBeenCalledWith(column, false);
  });
  ...
  it('should call event emitter', () => {
    ...
    vi.spyOn(component.showMore, 'emit').mockImplementation(() => {
  ...
  it('should return detail columns and not call sort array using detail column', () => {
    ...
    vi.spyOn(component as any, 'sortArray').mockImplementation(() => {});
  ...
  describe('Methods:', () => {
    ...
    it('ngOnChanges: should call `calculateHeightTableContainer` if height is changed', () => {
      vi.spyOn(component, 'calculateHeightTableContainer').mockImplementation(() => {});
      const height = 400;
    ...
    it('ngOnChanges: should call `changeSizeLoading` if height is changed', () => {
      vi.spyOn(component, 'changeSizeLoading').mockImplementation(() => {});
      const height = 400;
      const changes = <any>{ height };
      component.height = height;
    ...
    describe('configAfterSelectRow: ', () => {
      ...
      it('should call unselectOtherRows and not call isEverySelected when singleSelect is `true`', () => {
        ...
        vi.spyOn(component as any, 'unselectOtherRows').mockImplementation(() => {});
        vi.spyOn(component as any, 'isEverySelected').mockImplementation(() => {});
    ...
    it('selectRow: should set $selected `true` at row and call `configAfterSelectRow` and `emitSelectEvents`', () => {
      ...
      vi.spyOn(component as any, 'configAfterSelectRow').mockImplementation(() => {});
      vi.spyOn(component as any, 'emitSelectEvents').mockImplementation(() => {});
    ...
    it('selectRow: should call setSelectedList after selecting a row', () => {
      ...
      vi.spyOn(component, 'setSelectedList').mockImplementation(() => {});
    ...
    it('emitSelectEvents: should emit `selected` if `row.$selected` is `true`', () => {
      ...
      vi.spyOn(component.selected, 'emit').mockImplementation(() => {});
    ...
    it('emitSelectEvents: should emit `unselected` if `row.$selected` is `false`', () => {
      const row = { id: 1, $selected: false };
      vi.spyOn(component.unselected, 'emit').mockImplementation(() => {});
    ...
    it('selectAllRows: should call `emitSelectEvents`', () => {
      ...
      vi.spyOn(component as any, 'emitSelectAllEvents').mockImplementation(() => {});
    ...
    describe('selectAllRows:', () => {
      ...
      it('should call emitSelectEvents and updateParentRowSelection', () => {
        ...
        vi.spyOn(component as any, 'emitSelectEvents').mockImplementation(() => {});
        vi.spyOn(component as any, 'updateParentRowSelection').mockImplementation(() => {});
    ...
    it('emitSelectAllEvents: should emit `allSelected` if `selectAll` is `true`', () => {
      ...
      vi.spyOn(component.allSelected, 'emit').mockImplementation(() => {});
    ...
    it('emitSelectAllEvents: should emit `allUnselected` if `selectAll` is `false`', () => {
      ...
      vi.spyOn(component.allUnselected, 'emit').mockImplementation(() => {});
    ...
    it(`sortArray: should call 'sortValues'`, () => {
      ...
      vi.spyOn(utilsFunctions, 'sortValues').mockImplementation(() => 0);
    ...
    'ascending', 'descending'`, () => {
      ...
      vi.spyOn(component.sortBy, 'emit');
    ...
    it('toggleDetail: should emit expanded if detail is opened', () => {
      ...
      vi.spyOn(component.expanded, 'emit').mockImplementation(() => {});
    ...
    it('toggleDetail: should emit collapsed if detail is closed', () => {
      ...
      vi.spyOn(component.collapsed, 'emit').mockImplementation(() => {});
    ...
    it('onChangeColumns: should call `setMainColumns`, `setColumnMasterDetail` and `setSubtitleColumns`', () => {
      const spySetMainColumns = vi.spyOn(component as any, 'setMainColumns').mockImplementation(() => {});
      const spySetColumnMasterDetail = vi.spyOn(component as any, 'setColumnMasterDetail').mockImplementation(() => {});
      const spySetSubtitleColumns = vi.spyOn(component as any, 'setSubtitleColumns').mockImplementation(() => {});
    ...
    describe('setService', () => {
      it('should be called with string url and set service url and method is GET', () => {
        vi.spyOn(component['poTableService'], 'setUrl').mockImplementation(() => {});
    ...
    describe('ngOnDestroy:', () => {
      ...
      it(`should unsubscribe 'poTableServiceSubscription'`, () => {
        vi.spyOn(fakeSubscription, 'unsubscribe').mockImplementation(() => {});
  ...
  describe('Properties:', () => {
    ...
    describe('p-components-size', () => {
      ...
      it('onThemeChange: should call applySizeBasedOnA11y', () => {
        vi.spyOn(component as any, 'applySizeBasedOnA11y').mockImplementation(() => {});
    ...
    it('p-columns, p-items: shouldn`t call `getDefaultColumns` to set default column if doesn`t have items and columns', () => {
      vi.spyOn(component as any, 'getDefaultColumns').mockImplementation(() => {});
