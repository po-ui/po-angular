...
describe('PoTableSubtitleFooterComponent:', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PoTableSubtitleFooterComponent, PoTableSubtitleCircleComponent, PoTableShowSubtitleComponent],
  ...
  describe('Methods:', () => {
    ...
    it('ngAfterViewInit: should call `initializeResizeListener` and `debounceResize`', () => {
      vi.spyOn(component as any, 'initializeResizeListener').mockImplementation(() => {});
      vi.spyOn(component as any, 'debounceResize').mockImplementation(() => {});
    ...
    it('ngOnDestroy: should call `removeResizeListener`', () => {
      vi.spyOn(component as any, 'removeResizeListener').mockImplementation(() => {});
    ...
    describe('ngDoCheck', () => {
      ...
      and 'isVisible' is 'false'`, () => {
        ...
        vi.spyOn(component as any, 'toggleShowCompleteSubtitle').mockImplementation(() => {});
    ...
    it('debounceResize: should call `toggleShowCompleteSubtitle`', async () => {
      vi.useFakeTimers();
      vi.spyOn(component as any, 'toggleShowCompleteSubtitle').mockImplementation(() => {});
