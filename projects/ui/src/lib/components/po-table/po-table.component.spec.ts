...
describe('PoTableComponent:', () => {
  ...
  describe('Methods:', () => {
    ...
    describe('updateItem:', () => {
      ...
      it('ngAfterViewChecked: should schedule syncColumnWidths when computedColumnWidths is empty and viewport has rendered rows', done => {
        component.height = 400;
      ...
      it('ngAfterViewChecked: should not call setupColumnWidthSync when resizeObserver is already configured', () => {
        component.virtualScroll = true;
        component['resizeObserver'] = { observe: () => {}, disconnect: () => {}, unobserve: () => {} } as any;
        component['virtualScrollOverflowConfigured'] = true;
        ...
        expect(component['setupColumnWidthSync']).not.toHaveBeenCalled();
      });
