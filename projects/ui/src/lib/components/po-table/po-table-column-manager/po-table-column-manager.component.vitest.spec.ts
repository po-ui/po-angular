...
describe('PoTableColumnManagerComponent:', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PoTableColumnManagerComponent, PoTableListManagerComponent],
  ...
  describe('Methods:', () => {
    describe('ngOnChanges:', () => {
      ...
      it(`ngOnChanges: should call 'onChangeColumns' if 'columns' is defined`, () => {
        ...
        vi.spyOn(component as any, 'onChangeColumns').mockImplementation(() => {});
      ...
      it(`ngOnChanges: should call 'updateValues' with 'columns' if 'maxColumns' is defined`, () => {
        ...
        vi.spyOn(component as any, 'updateValues').mockImplementation(() => {});
      ...
      it(`ngOnChanges: should open page slide if 'lastVisibleColumnsSelected.currentValue' is defined`, () => {
        ...
        vi.spyOn(component.pageSlideColumnsManager, 'open').mockImplementation(() => {});
    ...
    describe('checkChanges:', () => {
      it('should call `verifyToEmitChange`', () => {
        const fakeEvent = [];
        vi.spyOn(component as any, 'verifyToEmitChange').mockImplementation(() => {});
      ...
      it('should call `verifyToEmitVisibleColumns` if emit is true', () => {
        const fakeEvent = [];
        const fakeEmit = true;
        vi.spyOn(component as any, 'verifyToEmitVisibleColumns').mockImplementation(() => {});
    ...
    describe('verifyToEmitChange:', () => {
      it('should call `emitChangesToSelectedColumns` if allowsChangeVisibleColumns is true', () => {
        ...
        vi.spyOn(component as any, 'emitChangesToSelectedColumns').mockImplementation(() => {});
      ...
      it('should call `disabledLastColumn` and `mapTableColumnsToCheckboxOptions` if columns length is 1', () => {
        vi.spyOn(component as any, 'mapTableColumnsToCheckboxOptions').mockReturnValue([]);
        vi.spyOn(component as any, 'disabledLastColumn').mockReturnValue([]);
    ...
    it('emitChangesToSelectedColumns: should update `visibleColumns` and call `getVisibleTableColumns` and `visibleColumnsChange.emit`', () => {
      ...
      vi.spyOn(component.visibleColumnsChange, 'emit');
    ...
    describe('verifyToEmitVisibleColumns:', () => {
      it('should call `verifyRestoreValues` if `restoreDefaultEvent` is true', () => {
        ...
        vi.spyOn(component as any, 'verifyRestoreValues').mockImplementation(() => {});
        vi.spyOn(component as any, 'verifyOnClose').mockImplementation(() => {});
    ...
    describe('verifyOnClose:', () => {
      it(`should call 'emitVisibleColumns' if 'allowsEmission' is true`, () => {
        ...
        vi.spyOn(component as any, 'emitVisibleColumns').mockImplementation(() => {});
    ...
    it(`restore: should update 'restoreDefaultEvent' and should call 'getVisibleColumns' and 'checkChanges'`, () => {
      ...
      vi.spyOn(component as any, 'getVisibleColumns').mockReturnValue(fakeDefaultVisibleColumns);
      vi.spyOn(component as any, 'checkChanges').mockImplementation(() => {});
      vi.spyOn(component.initialColumns, 'emit');
    ...
    describe('getColumnTitleLabel:', () => {
      ...
      it(`should call 'capitalizeFirstLetter' to set 'getColumnTitleLabel' if 'column.label' is undefined`, () => {
        ...
        vi.spyOn(utilsFunctions, 'capitalizeFirstLetter').mockReturnValue(label);
      ...
      it(`should return false if 'column.label' and 'column.property' are undefined`, () => {
        ...
        vi.spyOn(utilsFunctions, 'capitalizeFirstLetter').mockReturnValue(false as any);
    ...
    describe('initializeListeners:', () => {
      it(`should call 'renderer.listen' to set 'resizeListener'`, () => {
        ...
        vi.spyOn(component['renderer'], 'listen').mockReturnValue(resizeListenerFunction);
      ...
      it(`should call 'popover.close' into callback of renderer.listen`, () => {
        ...
        vi.spyOn(component.popover, 'close').mockImplementation(() => {});
        vi.spyOn(component['renderer'], 'listen').mockImplementation((window, resize, callback: any) => callback());
      ...
      it(`should not call 'popover.close' into callback of renderer.listen if it is undefined`, () => {
        ...
        const spy = vi.spyOn(component.popover, 'close').mockImplementation(() => {});
    ...
    describe('mapTableColumnsToCheckboxOptions:', () => {
      it(`mapTableColumnsToCheckboxOptions: should convert table columns to checkbox options and return it without detail columns`, () => {
        ...
        vi.spyOn(component as any, 'isDisableColumn').mockReturnValueOnce(false).mockReturnValueOnce(true).mockReturnValueOnce(true).mockReturnValueOnce(true);
