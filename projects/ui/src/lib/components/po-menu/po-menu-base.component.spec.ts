...
describe('PoMenuBaseComponent:', () => {
  ...
  beforeEach(() => {
    ...
    component = new PoMenuComponent(menuGlobalService, menuService, languageService, poThemeServiceMock);
    component.menus = [
      {
        label: 'Level 1.1',
        link: '/level-1-1',
  ...
  describe('Properties:', () => {
    ...
    describe('componentsSize', () => {
      ...
      it('should set the default value to medium when an invalid value is provided and no accessibility level is configured', () => {
        component.componentsSize = 'small';

        expect(component['_componentsSize']).toBe('medium');
      });
