...
import { ElementRef, EventEmitter, SimpleChange, SimpleChanges, CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA } from '@angular/core';
...
describe('PoSearchComponent', () => {
  ...
  const controlPositionMock = { adjustPosition: vi.fn(), setElements: vi.fn() };
  ...
  beforeEach(() => {
    ...
    component['controlPosition'] = controlPositionMock as any;
    ...
    vi.spyOn(component.filteredItemsChange, 'emit').mockImplementation(() => {});
    vi.spyOn(component.listboxOnClick, 'emit').mockImplementation(() => {});
  ...
  describe('onCleanKeydown', () => {
    it('should clear search, focus input, prevent default and stop propagation when escape is pressed and type is locate', () => {
      ...
      vi.spyOn(component, 'clearSearch').mockImplementation(() => {});
  ...
  describe('onEnterKey', () => {
    ...
    beforeEach(() => {
      ...
      vi.spyOn(component, 'closeListbox').mockImplementation(() => {});
      vi.spyOn(component, 'onSearchChange').mockImplementation(() => {});
    });
  ...
  describe('onSearchChange', () => {
    it('should emit changeModel and return if type is locate and changeModel is observed', () => {
      component.type = 'locate';
      Object.defineProperty(component.changeModel, 'observed', { get: () => true, configurable: true });
      vi.spyOn(component.changeModel, 'emit').mockImplementation(() => {});
  ...
  describe('onFocus', () => {
    ...
    it('should emit focusEvent when it is observed', () => {
      ...
      vi.spyOn(component.focusEvent, 'emit').mockImplementation(() => {});

      Object.defineProperty(component.focusEvent, 'observed', { value: true, configurable: true });
    ...
    it('should not emit focusEvent when it is not observed', () => {
      ...
      Object.defineProperty(component.focusEvent, 'observed', { value: false, configurable: true });
  ...
  describe('onInputHandler', () => {
    ...
    it('should call onSearchChange once with (value, false) if type is locate', () => {
      component.type = 'locate';
      const spy = vi.spyOn(component, 'onSearchChange').mockImplementation(() => {});
    ...
    it('should call onSearchChange twice if type is not locate and type is "action"', () => {
      ...
      expect(spy.mock.calls[0]).toEqual(['abc', false]);
      expect(spy.mock.calls[1]).toEqual(['abc', true]);
    });
    ...
    it('should call onSearchChange twice if type is not locate and type is not "action"', () => {
      ...
      expect(spy).toHaveBeenCalledTimes(2);
      expect(spy.mock.calls[0]).toEqual(['abc', false]);
      expect(spy.mock.calls[1]).toEqual(['abc', false]);
    });
  });
  ...
  describe('onBlur', () => {
    ...
    it('should emit blur event if observed', () => {
      Object.defineProperty(component.blur, 'observed', { get: () => true, configurable: true });
      vi.spyOn(component.blur, 'emit').mockImplementation(() => {});
    ...
    it('should not emit blur event if not observed', () => {
      Object.defineProperty(component.blur, 'observed', { get: () => false, configurable: true });
      vi.spyOn(component.blur, 'emit').mockImplementation(() => {});
  ...
  describe('showListbox: when searching with listbox', () => {
    ...
    it('initializeListeners: should call removeListeners and initialize click, resize and scroll listeners', () => {
      ...
      const spyRemoveListeners = vi.spyOn(component as any, 'removeListeners').mockImplementation(() => {});
    ...
    it('should initialize all Listeners correctly', async () => {
      vi.spyOn(component as any, 'removeListeners').mockImplementation(() => {});
      vi.spyOn(component as any, 'adjustContainerPosition').mockImplementation(() => {});
    ...
    it('should focus the listbox if the input have a arrowdown keypress', () => {
      ...
      vi.spyOn(component as any, 'focusItem').mockImplementation(() => {});
    ...
    it('should close the listbox and focus the search input if the input has a keydown event with the Escape key', () => {
      vi.spyOn(component, 'closeListbox').mockImplementation(() => {});
      const focusSpy = vi.spyOn(component.poSearchInput.nativeElement, 'focus').mockImplementation(() => {});
    ...
    it('should focus the first option in the listbox and set its class to cdk-option-active', async () => {
      const container = document.createElement('div');
      ...
      vi.spyOn(mockListboxItem, 'focus').mockImplementation(() => {});
  ...
  describe('updatePaddingRightLocate', () => {
    beforeEach(() => {
      ...
      Object.defineProperty(counterElement, 'offsetWidth', { value: 42, configurable: true });
  ...
  describe('locateCounter ViewChild setter', () => {
    ...
    it('should set _locateCounter, create ResizeObserver and observe the element', () => {
      ...
      const updateSpy = vi.spyOn(component as any, 'updatePaddingRightLocate').mockImplementation(() => {});
  ...
  describe('ngOnChanges', () => {
    it('should call updateShowSearchLocateControls and updatePaddingRightLocate when type changes', () => {
      const updateShowSpy = vi.spyOn(component as any, 'updateShowSearchLocateControls').mockImplementation(() => {});
      const updatePaddingSpy = vi.spyOn(component as any, 'updatePaddingRightLocate').mockImplementation(() => {});
  ...
  it('should emit footerAction and call closeListbox', () => {
    vi.spyOn(component.footerAction, 'emit').mockImplementation(() => {});
    vi.spyOn(component, 'closeListbox').mockImplementation(() => {});
