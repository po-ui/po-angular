...
describe('PoStepperCircleComponent:', () => {
  ...
  describe('Properties:', () => {
    ...
    it('isMediumStep: should return `true` if `size` is greater than `32` and `isLargeStep` is `false`.', () => {
      ...
      vi.spyOn(component, 'isLargeStep', 'get').mockReturnValue(false);
    ...
    it('isMediumStep: should return `false` if `size` is greater than `32` and `isLargeStep` is `true`.', () => {
      ...
      vi.spyOn(component, 'isLargeStep', 'get').mockReturnValue(true);
  ...
  describe('Templates:', () => {
    it('should find `po-stepper-circle-content-md` in `span` if `isMediumStep` is `true`.', () => {
      vi.spyOn(component, 'isMediumStep', 'get').mockReturnValue(true);
    ...
    it('should find `po-stepper-circle-active` if `isActive` is true.', () => {
      vi.spyOn(component, 'isError', 'get').mockReturnValue(false);
      vi.spyOn(component, 'isActive', 'get').mockReturnValue(true);
    ...
    it('should find `po-stepper-circle-active` if `isError` is true.', () => {
      vi.spyOn(component, 'isError', 'get').mockReturnValue(true);
      vi.spyOn(component, 'isActive', 'get').mockReturnValue(false);
    ...
    it('should find `po-icon` if `isDone` is true.', () => {
      ...
      vi.spyOn(component, 'isDone', 'get').mockReturnValue(true);
    ...
    it('shouldn`t find `po-icon` if `isDone` and `icons` is false.', () => {
      component.icons = false;
      vi.spyOn(component, 'isDone', 'get').mockReturnValue(false);
