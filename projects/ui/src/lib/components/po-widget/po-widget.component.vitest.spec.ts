...
import { SimpleChange, SimpleChanges, TemplateRef, CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA } from '@angular/core';
...
describe('PoWidgetComponent with title and actions', () => {
  ...
  it('should be call checkDefaultActions if help changes', () => {
    vi.spyOn(component, <any>'checkDefaultActions');
  ...
  it('should call detectChanges', () => {
    vi.spyOn(component['cd'], <any>'detectChanges');
    component.tagLabel = 'test';
    const changes: SimpleChanges = {
  ...
  // TODO: Test requires PoPopupModule rendered DOM (not available with CUSTOM_ELEMENTS_SCHEMA)
  it.skip('should be call toggle of poPopupComponent', () => {
    vi.spyOn(component, 'togglePopup');
  ...
  describe('Methods:', () => {
    ...
    it('runTitleAction: should call event.stopPropagation and titleAction.emit', () => {
      vi.spyOn(eventClick, 'stopPropagation');
      vi.spyOn(component.titleAction, 'emit');
    ...
    // TODO: Requires rendered po-popup DOM
    it.skip('runTitleAction: shouldn`t call event.stopPropagation and titleAction.emit if disabled is true', () => {
    ...
    it('onClick: should call click.emit if disabled is false', () => {
      ...
      const spyClickEmit = vi.spyOn(component.click, 'emit');
    ...
    it('runPrimaryAction: shouldn`t call event.stopPropagation and primaryAction.emit if disabled is true', () => {
      ...
      const spyPrimaryActionEmit = vi.spyOn(component.primaryAction, 'emit');
    ...
    it('runSecondaryAction: shouldn`t call event.stopPropagation and secondaryAction.emit if disabled is true', () => {
      ...
      vi.spyOn(component.secondaryAction, 'emit');
    ...
    it('runSecondaryAction: should call event.stopPropagation and secondaryAction.emit if disabled is false', () => {
      ...
      const spySecondaryActionEmit = vi.spyOn(component.secondaryAction, 'emit');
    ...
    it('settingOutput: shouldn`t call event.stopPropagation and setting.emit if disabled is true', () => {
      ...
      const spySettingEmit = vi.spyOn(component.setting, 'emit');
    ...
    it('settingOutput: should call event.stopPropagation and setting.emit if disabled is false', () => {
      ...
      vi.spyOn(component.setting, 'emit');
  ...
  describe('Templates:', () => {
    ...
    // TODO: Requires rendered po-popup DOM for click propagation
    it.skip('should be called the click event when clicked on the `po-widget` area.', () => {
      component.click.subscribe(() => {});
...
describe('PoWidgetComponent with actions', () => {
  ...
  it('should not add action if "observed" is false', () => {
    vi.spyOn(component, 'settingOutput').mockImplementation(() => {});
  ...
  // TODO: Requires PoButtonComponent mock with focus method
  it.skip('shoukd focus on po-button when action is closed', () => {
