...
export class PoChartGaugeUtils {
  ...
  setListTypeGauge(serie: any, fontSizes: { fontSizeMd: number; fontSizeLg: number; fontSizeSubtitle: number }) {
    ...
    serie.title = {
      offsetCenter: this.component.isGaugeSingle ? [0, '-10%'] : [0, '-115%'],
      fontSize: fontSizes.fontSizeSubtitle,
      fontWeight: Number(this.component.getCSSVariable('--font-weight-subtitle-gauge', '.po-chart')),
      fontFamily: this.component.getCSSVariable('--font-family-subtitle-gauge', '.po-chart'),
      color: this.component.getCSSVariable('--color-subtitle-gauge', '.po-chart'),
      width: this.component.isGaugeSingle ? properties.widthSubtitle : 400,
      overflow: 'break'
    };
    serie.data = [
      {
        ...
        name: this.component.isGaugeSingle
          ? this.component.options?.descriptionGauge || data.label
          : this.component.options?.descriptionGauge
      }
    ];
    return serie;
  }
