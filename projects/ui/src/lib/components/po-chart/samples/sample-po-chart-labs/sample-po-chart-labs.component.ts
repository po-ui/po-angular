...
export class SamplePoChartLabsComponent implements OnInit {
  ...
  selectedValuesLegend: Array<string> = [];
  selectedLegendVerticalPosition: PoChartOptions['legendVerticalPosition'];
  selectedLegendPosition: PoChartOptions['legendPosition'];
  selectedRendererOption: PoChartOptions['rendererOption'];
