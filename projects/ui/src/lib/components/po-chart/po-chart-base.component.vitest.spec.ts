...
class PoChartBaseComponentMock extends PoChartBaseComponent {}

describe('PoChartBaseComponent', () => {
  let component: PoChartBaseComponentMock;
  ...
  describe('Outputs:', () => {
    it('p-series-click: should emit event', () => {
      ...
      vi.spyOn(component.seriesClick, 'emit');
    ...
    it('p-series-hover: should emit event', () => {
      const mockEvent = { label: 'Test', value: 10 };
      vi.spyOn(component.seriesHover, 'emit');
