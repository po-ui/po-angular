...
describe('PoToolbarComponent:', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PoToolbarComponent, PoToolbarActionsComponent, PoToolbarNotificationComponent, PoToolbarProfileComponent],
  ...
  describe('Methods:', () => {
    it('ngOnInit: should call `setTitle` on ngOnInit', () => {
      ...
      const spy = vi.spyOn(component as any, 'setTitle');

      component.ngOnInit();

      expect(spy).toHaveBeenCalledWith('Novo programa');
    });
