...
export class PoPageDetailBaseComponent {
  ...
  /**
   * Função que será disparada ao clicar no botão de "Voltar".
   *
   * ```
   * <po-page-detail [p-back]="myBackFunction.bind(this)">
   * </po-page-detail>
   * ```
   *
   * > Caso não utilizar esta propriedade, o botão de "Voltar" não será exibido.
   */
  @Input('p-back') back?: Function;

  /**
   * Função que será disparada ao clicar no botão de "Editar".
   *
   * ```
   * <po-page-detail [p-edit]="myEditFunction.bind(this)">
   * </po-page-detail>
   * ```
   *
   * > Caso não utilizar esta propriedade, o botão de "Editar" não será exibido.
   */
  @Input('p-edit') edit?: Function;

  /**
   * Função que será disparada ao clicar no botão de "Remover".
   *
   * ```
   * <po-page-detail [p-remove]="myRemoveFunction.bind(this)">
   * </po-page-detail>
   * ```
   *
   * > Caso não utilizar esta propriedade, o botão de "Remover" não será exibido.
   */
  @Input('p-remove') remove?: Function;
}
