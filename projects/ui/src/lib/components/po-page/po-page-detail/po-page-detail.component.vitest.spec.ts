...
describe('PoPageDetailComponent:', () => {
  ...
  it('should be execute method of parent.', () => {
  ...
  describe('Methods:', () => {
    it(`hasEditFn: should return '' if have a edit action and property is 'icon'`, () => {
      component.edit.observers.push(of({}) as any);
    ...
    it(`hasEditFn: should return '' if property doesn't 'icon' or 'type' (undefined and null)`, () => {
      expect(component.hasEditFn('invalid')).toBe('');
    ...
    and property is 'icon'`, () => {
      component.edit.observers.length = 0;
      component.remove.observers.push(of({}) as any);
  ...
  describe('Templates:', () => {
    ...
    it('should apply only `an-pencil-simple` if have a back, remove and edit functions.', () => {
      component.back.observers.push(of({}) as any);
      component.remove.observers.push(of({}) as any);
      component.edit.observers.push(of({}) as any);
