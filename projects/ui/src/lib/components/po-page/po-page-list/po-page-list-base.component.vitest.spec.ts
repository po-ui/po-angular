...
describe('PoPageListBaseComponent:', () => {
  ...
  it('should be created', () => {
    expect(component instanceof PoPageListBaseComponent).toBe(true);
  });
  ...
  describe('Properties:', () => {
    ...
    it('should return object when set disclaimerGroup with undefined', () => {
      ...
      expect(typeof component.disclaimerGroup === 'object').toBe(true);
    });
    ...
    it('p-title: should call recalculateHeaderSize', async () => {
