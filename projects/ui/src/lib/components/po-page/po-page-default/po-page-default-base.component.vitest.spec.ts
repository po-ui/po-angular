...
describe('PoPageDefaultBaseComponent:', () => {
  ...
  it('should be created', () => {
    expect(component instanceof PoPageDefaultBaseComponent).toBe(true);
  });
  ...
  describe('Properties:', () => {
    ...
    it('p-title: should get title and call recalculateHeaderSize when set title', async () => {
      component.poPageContent = {
        recalculateHeaderSize: vi.fn()
      } as any;
    ...
    it('p-subtitle: should call recalculateHeaderSize when set subtitle', async () => {
      component.poPageContent = {
        recalculateHeaderSize: vi.fn()
      } as any;
    ...
    it('p-breadcrumb: should call recalculateHeaderSize when set breadcrumb', async () => {
      component.poPageContent = {
        recalculateHeaderSize: vi.fn()
      } as any;
