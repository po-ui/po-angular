...
describe('PoSlideItemComponent:', () => {
  ...
  describe('Methods:', () => {
    it('setLinkType: should return `noLink` if `template` is `defined`', () => {
      component.template = { templateRef: {} } as any;
      component.link = 'link';
  ...
  describe('Template:', () => {
    it(`should apply 'po-slide-item-background-image' if 'template' is 'undefined' and 'isIEOrEdge' is 'true'`, () => {
      component.template = undefined;
    ...
    it(`should apply 'item.alt' in tag '<img>'`, () => {
      component.template = undefined;
      component.image = 'imageUrl';
      component.alt = 'alt';
      component.isIEOrEdge = false;
    ...
    it(`should apply 'imageHeight' in tag '<img>' 'style.height.px'`, () => {
      component.template = undefined;
      component.image = 'imageUrl';
    ...
    it(`should apply 'item.image' in tag '<img>' src`, () => {
      component.template = undefined;
      component.image = 'imageUrl';
      component.alt = 'alt';
      component.isIEOrEdge = false;
