...
describe('PoSlideComponent:', () => {
  ...
  describe('Methods:', () => {
    ...
    it('onResize: should trigger onResize method when window is resized ', () => {
      const spyOnResize = vi.spyOn(component, 'onResize');
    ...
    it('onResize: should call `setSlideItemWidth` and `goToItem` with `currentSlideIndex`', async () => {
      vi.spyOn(component as any, 'setSlideItemWidth').mockImplementation(() => {});
      vi.spyOn(component, 'goToItem').mockImplementation(() => {});
    ...
    it('ngOnDestroy: should call resizeSubscription.unsubscribe', async () => {
      const spyResizeSubscription = vi.spyOn(component['resizeSubscription'], 'unsubscribe');
    ...
    describe('ngDoCheck:', () => {
      it('should call `setSlideItemWidth` and set `isLoaded` to true if isn`t loaded and has elements', () => {
        ...
        vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(true);
      ...
      it('shouldn`t call `setSlideItemWidth` isn`t loaded but has elements', () => {
        component['isLoaded'] = false;
        vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(false);
      ...
      it('should call `startSlide` and  `setSlideItemWidth` if has slides, isn`t loaded and has elements', () => {
        component['isLoaded'] = false;
        vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(true);
        vi.spyOn(component, 'hasSlides', 'get').mockReturnValue(true);

        vi.spyOn(component as any, 'setSlideItemWidth').mockImplementation(() => {});
        vi.spyOn(component as any, 'startSlide').mockImplementation(() => {});
      ...
      it('shouldn`t call `startSlide` if doesn`t have slides, isn`t loaded and has elements, but should call `setSlideItemWidth`', () => {
        ...
        vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(true);
        vi.spyOn(component, 'hasSlides', 'get').mockReturnValue(false);
    ...
    it('ngOnChanges: should call `setSlideHeight` with `this.height` if `changes.height` is defined', () => {
      ...
      vi.spyOn(component, 'setSlideHeight').mockImplementation(() => {});

      component.ngOnChanges({ height } as any);
    ...
    it('goToItem: should set `currentSlideIndex` and call `animate` with `offset`', () => {
      ...
      vi.spyOn(component as any, 'startInterval').mockImplementation(() => {});
    ...
    it(`nextControl: should call 'next'`, () => {
      vi.spyOn(component, 'next').mockImplementation(() => {});
    ...
    it(`previousControl: should call 'previous'`, () => {
      vi.spyOn(component, 'previous').mockImplementation(() => {});
    ...
    it(`setSlideHeigth: should call 'setHeight' with 'heigth'`, () => {
      ...
      vi.spyOn(component as any, 'setHeight').mockImplementation(() => {});
    ...
    it(`animate: shouldn't call 'buildTransitionAnimation' with offset if doesn't have elements`, () => {
      ...
      vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(false);
      vi.spyOn(component as any, 'buildTransitionAnimation').mockImplementation(() => {});
    ...
    it(`buildTransitionAnimation: should call builder`, () => {
      ...
      vi.spyOn(component['builder'], 'build');
    ...
    describe('setDefaultHeight:', () => {
      ...
      it('should set `imageHeight` and slide height to default height is undefined and is image slide', () => {
        ...
        vi.spyOn(component as any, 'isImageSlide', 'get').mockReturnValue(true);
        component['setDefaultHeight'](height);
        expect(component.imageHeight).toBe(defaultHeight);
      });
      ...
      it('should set `imageHeight` to undefined if height is not defined and isn`t image slide', () => {
        const height = undefined;
        vi.spyOn(component as any, 'isImageSlide', 'get').mockReturnValue(false);
        component['setDefaultHeight'](height);
    ...
    describe('setHeight:', () => {
      it('should set slide height and imageHeight, shouldn`t call `setDefaultHeight` if height is greater than 192px', () => {
        ...
        vi.spyOn(component as any, 'setDefaultHeight').mockImplementation(() => {});
    ...
    it(`cancelInterval: should cancel interval and shouldn't call 'next' function`, async () => {
    ...
    describe('setSlideItems:', () => {
      it(`should call 'createArrayFromSlides' if slides are defined and template is undefined.`, () => {
        ...
        vi.spyOn(component as any, 'createArrayFromSlides').mockImplementation(() => {});
      ...
      it(`should call 'createArrayForTemplate' if slides are defined and template is defined.`, () => {
        const slidesArray = [{ alt: '1' }, { alt: '2' }, { alt: '3' }, { alt: '4' }];
        component.slideContentTemplate = { templateRef: {} } as any;

        vi.spyOn(component, 'hasSlides', 'get').mockReturnValue(true);

        vi.spyOn(component as any, 'createArrayForTemplate').mockImplementation(() => {});
      ...
      it(`should call 'cancelInterval' and 'setSlideItems' to [].`, () => {
        ...
        vi.spyOn(component as any, 'cancelInterval').mockImplementation(() => {});
        component['setSlideItems'](slidesArray);
    ...
    describe('startInterval:', () => {
      ...
      it(`should call 'next' after interval of 1 second if has slides and elements`, async () => {
        component.slides = [{ alt: '1' }, { alt: '2' }, { alt: '3' }, { alt: '4' }];
        fixture.detectChanges();

        // In jsdom offsetWidth is 0, mock hasElements to return true
        vi.spyOn(component as any, 'hasElements', 'get').mockReturnValue(true);
  ...
  describe('Properties:', () => {
    it(`hasElements: should return true if has 'slides' to create 'itemsElements'`, () => {
      ...
      // In jsdom offsetWidth is 0, so mock it to simulate a real browser
      Object.defineProperty(component['slide'].nativeElement, 'offsetWidth', { value: 500, configurable: true });
  ...
  describe('Templates:', () => {
    ...
    it(`should  call 'previous' if slide arrow previous was clicked`, () => {
      component.slides = ['item1', 'item2', 'item3'];
      vi.spyOn(component, 'previousControl').mockImplementation(() => {});
    ...
    it(`should call 'next' if slide arrow next was clicked.`, () => {
      component.slides = ['item1', 'item2', 'item3'];
      vi.spyOn(component, 'nextControl').mockImplementation(() => {});
