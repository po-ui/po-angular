...
describe('PoProgressComponent:', () => {
  ...
  describe('Methods:', () => {
    ...
    it('callAction: should emit customActionClick event', () => {
      vi.spyOn(component.customActionClick, 'emit');
  ...
  describe('Circle shape - private methods:', () => {
    ...
    describe('ngOnInit circle detection:', () => {
      it('should set parentSize when parent has allocated height', () => {
        ...
        Object.defineProperty(grandparent, 'clientWidth', { value: 200, configurable: true });
      ...
      it('should set parentSize when constrained ancestor has explicit height', () => {
        ...
        Object.defineProperty(ancestor, 'clientWidth', { value: 300, configurable: true });
        Object.defineProperty(ancestor, 'clientHeight', { value: 300, configurable: true });
    ...
    describe('ngAfterViewInit:', () => {
      ...
      it('should create ResizeObserver when observeTarget exists', () => {
        ...
        Object.defineProperty(ancestor, 'clientWidth', { value: 200, configurable: true });
