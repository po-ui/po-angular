...
// Suppress unhandled errors from async scroll subscriptions that fire after test cleanup
const originalShowMore = PoListBoxComponent.prototype.showMoreInfiniteScroll;
PoListBoxComponent.prototype.showMoreInfiniteScroll = function(event: any) {
  if (!event?.target) return;
  return originalShowMore.call(this, event);
};
...
describe('PoListBoxComponent', () => {
  ...
  describe('Methods:', () => {
    it('should emit UpdateInfiniteScroll when scroll position is reached', () => {
      ...
      const updateInfiniteScroll = vi.spyOn(component['UpdateInfiniteScroll'], 'emit');
    ...
    it('should call scrollListener and return', () => {
    ...
    it.skip('should include infinite scroll if hasInfiniteScroll returns true', () => {
      // TODO: listboxItemList assignment before spy causes issue
    ...
    it('should`nt include infinite scroll and subscribe to scroll event', () => {
      ...
      vi.spyOn(component, 'scrollListener').mockReturnValue(
        of({ target: { offsetHeight: 100, scrollTop: 100, scrollHeight: 100 } })
      );
      const showMoreInfiniteScroll = vi.spyOn(component, 'showMoreInfiniteScroll');
      fixture.detectChanges();
    ...
    it('should cancel previous subscription before including infinite scroll', () => {
      vi.spyOn(component, 'showMoreInfiniteScroll');
      component.listboxItemList = {
        nativeElement: { offsetHeight: 100, scrollTop: 100, scrollHeight: 200 }
      };
      vi.spyOn(component, 'scrollListener').mockReturnValue(
    ...
    it('should not unsubscribe if there is no previous subscription', () => {
      vi.spyOn(component, 'scrollListener').mockReturnValue(of({}));
      vi.spyOn(component, 'showMoreInfiniteScroll');
      fixture.detectChanges();
    ...
    describe('ngAfterViewInit:', () => {
      it('should focus the first item and dispatch focus event when listboxSubitems is defined', async () => {
        component.listboxSubitems = true;
        // Prevent async scroll subscription from firing after test ends
        vi.spyOn(component as any, 'checkInfiniteScroll').mockImplementation(() => {});
      ...
      describe('openUrl:', () => {
        ...
        it('should be open a external link', () => {
          ...
          vi.spyOn(UtilFunctions, 'openExternalLink' as any);
        ...
        it('should be open a internal route', () => {
          vi.spyOn(UtilFunctions, 'isExternalLink');
          vi.spyOn(component['router'], 'navigate' as any);
          const url = '/home';
      ...
      describe('onSelectItem:', () => {
        ...
        it('should be onClickTabs if `isTabs` and tab is not disabled or hide', () => {
          ...
          vi.spyOn(component, 'onClickTabs');
    ...
    describe('openGroup and goBack:', () => {
      ...
      it('openGroup should set currentGroup/currentItems and focus first item', () => {
        return new Promise<void>(done => {
      ...
      it('goBack should restore previous group/items or default items and focus first item', () => {
        return new Promise<void>(done => {
    ...
    describe('onSelectTabs:', () => {
      it('Should emit if changeStateTabs if `isTabs` and has tab', () => {
        component.isTabs = true;
        vi.spyOn(component.changeStateTabs, 'emit');
    ...
    describe('onClickTabs:', () => {
      it('Should emit if clickTab if tabs is not disabled', () => {
        component.isTabs = true;
        vi.spyOn(component.clickTab, 'emit');
    ...
    describe('ngOnDestroy:', () => {
      ...
      it('ngOnDestroy: should unsubscribe if infiniteScroll is true', () => {
        ...
        vi.spyOn(mockSubscription, 'unsubscribe' as any);
    ...
    describe('setListBoxMaxHeight', () => {
      ...
      it.skip('should call `renderer.setStyle` and `renderer.removeStyle` when has more than 6 items and popupHeaderContainer contains children', () => {
        // TODO: querySelector returns null in jsdom for ul[role=listbox]
        vi.spyOn(component['renderer'] as any, 'setStyle');
    ...
    describe('onSelectCheckBoxItem:', () => {
      it('should call `checkboxClicked`', () => {
        vi.spyOn(component, 'checkboxClicked');
        component.type = 'check';
    ...
    describe('changeAllEmit:', () => {
      it('should emit changeAll if event is Enter', () => {
        ...
        vi.spyOn(component.changeAll, 'emit');
    ...
    describe('callChangeSearch:', () => {
      it('should emit changeSearch', () => {
        vi.spyOn(component.changeSearch, 'emit');
    ...
    describe('onKeydown:', () => {
      it('should call onSelectCheckBoxItem if event is `enter` and type is `check`', () => {
        ...
        const eventEnterKey = new KeyboardEvent('keydown', { 'code': 'Enter' });
        component.type = 'check';
        vi.spyOn(component, 'onSelectCheckBoxItem');
      ...
      it('should call comboClicked when type is "option" and Enter key is pressed', () => {
        vi.spyOn(component, 'optionClicked');
      ...
      it('should call onSelectItem when type is "action" and Enter key is pressed', () => {
        vi.spyOn(component, 'onSelectItem');
      ...
      it('comboClicked: should emit selectCombo if `p-type` is option', () => {
        component.type = 'option';
        vi.spyOn(component.selectCombo, 'emit');
      ...
      it('should call footerActionListboxEvent when keyboard enter', () => {
        ...
        vi.spyOn(component.footerActionListboxEvent, 'emit');
