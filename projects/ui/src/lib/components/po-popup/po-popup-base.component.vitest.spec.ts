...
describe('PoPopupBaseComponent:', () => {
  ...
  beforeEach(() => {
    component = new PoPopupBaseComponent();
  });

  it('should be created', () => {
    expect(component instanceof PoPopupBaseComponent).toBe(true);
  });
  ...
  describe('Properties:', () => {
    ...
    it('position: should update property `p-position` with valid values', () => {
      const validValues = [
        'right', 'right-top', 'right-bottom', 'top', 'top-left', 'top-right',
        'left', 'left-top', 'left-bottom', 'bottom', 'bottom-left', 'bottom-right'
      ];
