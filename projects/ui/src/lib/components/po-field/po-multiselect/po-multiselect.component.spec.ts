...
describe('PoMultiselectComponent:', () => {
  ...
  describe('Methods:', () => {
    describe('ngAfterViewInit:', () => {
      ...
      it("should set appendBox true if contains class 'enable-append-box' and is inside thf-grid-edit-template", fakeAsync(() => {
        component.inputElement = {
          nativeElement: {
            classList: {
      ...
      it('should not set appendBox if not inside thf-grid-edit-template', fakeAsync(() => {
        component.inputElement = {
          nativeElement: {
            classList: {
              contains: (cls: string) => cls === 'enable-append-box'
