...
describe('PoDatetimepickerBaseComponent:', () => {
  ...
  describe('writeValue:', () => {
    ...
    it('should call callOnChange with ISO model when date and time are valid', () => {
      ...
      const calledValue = (component.callOnChange as jasmine.Spy).calls.mostRecent().args[0];
  ...
  describe('callOnChange:', () => {
    it('should call onChangeModel when value is different from previous', () => {
      const fn = jasmine.createSpy('onChange');
      component.registerOnChange(fn);
    ...
    it('should not call onChangeModel when value is same as previous', () => {
      const fn = jasmine.createSpy('onChange');
      component.registerOnChange(fn);
