...
type BooleanInput = boolean | string | undefined;
...
export abstract class PoDatetimepickerBaseComponent implements ControlValueAccessor, Validator {
   ...
   * @default `false`
   */
  clean = input<BooleanInput>(undefined, { alias: 'p-clean' });
   ...
   * @default `false`
   */
  disabled = input<BooleanInput>(undefined, { alias: 'p-disabled' });
   ...
   */
  help = input<string | undefined>(undefined, { alias: 'p-help' });
   ...
   * @default `false`
   */
  loading = input<BooleanInput>(undefined, { alias: 'p-loading' });
   ...
   */
  localeInput = input<string | undefined>(undefined, { alias: 'p-locale' });
   ...
   */
  maxDateInput = input<string | Date | undefined>(undefined, { alias: 'p-max-date' });
   ...
   */
  maxTime = input<string | undefined>(undefined, { alias: 'p-max-time' });
   ...
   */
  minDateInput = input<string | Date | undefined>(undefined, { alias: 'p-min-date' });
   ...
   * Formato aceito: `HH:mm` ou `HH:mm:ss`.
   */
  minTime = input<string | undefined>(undefined, { alias: 'p-min-time' });
   ...
   * @default `5`
   */
  minuteInterval = input<number | undefined>(undefined, { alias: 'p-minute-interval' });
   ...
   * @default `false`
   */
  noAutocomplete = input<BooleanInput>(undefined, { alias: 'p-no-autocomplete' });
   ...
   */
  placeholder = input<string | undefined>(undefined, { alias: 'p-placeholder' });
   ...
   * @default `false`
   */
  readonly = input<BooleanInput>(undefined, { alias: 'p-readonly' });
   ...
   * @default `false`
   */
  required = input<BooleanInput>(undefined, { alias: 'p-required' });
   ...
   * @default `1`
   */
  secondInterval = input<number | undefined>(undefined, { alias: 'p-second-interval' });
   ...
   * @default `medium`
   */
  size = input<string | undefined>(undefined, { alias: 'p-size' });
   ...
   */
  timerFormat = input<PoTimerFormat | undefined>(undefined, { alias: 'p-format-time' });
   ...
   * @default Determinado pelo locale
   */
  dateFormat = input<string | undefined>(undefined, { alias: 'p-format-date' });
  ...
  formatTimeForDisplay(time: string): string {
    ...
    const seconds = parts.length > 2 ? parts[2] : null;
  ...
  private resolveFormat(): string {
    ...
    if (explicit) {
      ...
      if (lower.match(/dd/) && lower.match(/mm/) && lower.match(/yyyy/)) {
        return lower;
      }
    }
