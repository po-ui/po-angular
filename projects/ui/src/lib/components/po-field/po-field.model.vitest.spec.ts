...
describe('PoFieldModel', () => {
  ...
  it(`updateModel: should call propagateChange with model param`, () => {
    ...
    const spyPropagateChange = vi.spyOn(component as any, 'propagateChange' as any);
  ...
  it('setDisabledState: should set disabled property', () => {
    ...
    const markForCheck = vi.spyOn(component['cd'] as any, 'markForCheck' as any);
  ...
  it('writeValue: should call onWriteValue with value', () => {
    ...
    const spyOnWriteValue = vi.spyOn(component as any, 'onWriteValue' as any);
  ...
  describe('emitAdditionalHelp:', () => {
    it('should emit additionalHelp when isAdditionalHelpEventTriggered returns true', () => {
      ...
      vi.spyOn(component.additionalHelp, 'emit' as any);
      vi.spyOn(component as any, 'isAdditionalHelpEventTriggered' as any).mockReturnValue(true);
    ...
    it('should not emit additionalHelp when isAdditionalHelpEventTriggered returns false', () => {
      vi.spyOn(component.additionalHelp, 'emit' as any);
      vi.spyOn(component as any, 'isAdditionalHelpEventTriggered' as any).mockReturnValue(false);
