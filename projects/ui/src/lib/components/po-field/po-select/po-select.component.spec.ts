...
describe('PoSelectComponent:', () => {
  ...
  it("ngAfterViewInit: should set appendBox true if contains class 'enable-append-box' and is inside thf-grid-edit-template", fakeAsync(() => {
    component.selectElement = {
      nativeElement: {
        classList: {
          contains: (cls: string) => cls === 'enable-append-box'
        },
        closest: (selector: string) => (selector === '.thf-grid-edit-template' ? {} : null)
      }
    };
  ...
  it('ngAfterViewInit: should not set appendBox if not inside thf-grid-edit-template', fakeAsync(() => {
    component.selectElement = {
      nativeElement: {
        classList: {
          contains: (cls: string) => cls === 'enable-append-box'
