...
describe('PoCalendarHeaderComponent', () => {
  ...
  describe('Locale and Labels', () => {
    ...
    it('should initialize labels on ngOnInit', () => {
      vi.spyOn(langService, 'getPreviousMonthLabel').mockReturnValue('Mês anterior');
      vi.spyOn(langService, 'getNextMonthLabel').mockReturnValue('Próximo mês');
    ...
    it('should update labels when locale changes to English', () => {
      vi.spyOn(langService, 'setLanguage');
      vi.spyOn(langService, 'getPreviousMonthLabel').mockReturnValue('Previous month');
      vi.spyOn(langService, 'getNextMonthLabel').mockReturnValue('Next month');
    ...
    it('should update labels when locale changes to Spanish', () => {
      vi.spyOn(langService, 'setLanguage');
      vi.spyOn(langService, 'getPreviousMonthLabel').mockReturnValue('Mes anterior');
      vi.spyOn(langService, 'getNextMonthLabel').mockReturnValue('Próximo mes');
    ...
    it('should update labels when locale changes to Russian', () => {
      vi.spyOn(langService, 'setLanguage');
      vi.spyOn(langService, 'getPreviousMonthLabel').mockReturnValue('Предыдущий месяц');
      vi.spyOn(langService, 'getNextMonthLabel').mockReturnValue('Следующий месяц');
    ...
    it('should setup labels without setting language when locale is not defined', () => {
      ...
      vi.spyOn(langService, 'setLanguage');
      vi.spyOn(langService, 'getPreviousMonthLabel').mockReturnValue('Previous');
      vi.spyOn(langService, 'getNextMonthLabel').mockReturnValue('Next');
    ...
    it('should not call setupLabels on ngOnInit if labels already initialized', () => {
      ...
      vi.spyOn(langService, 'setLanguage');
      vi.spyOn(langService, 'getPreviousMonthLabel');
