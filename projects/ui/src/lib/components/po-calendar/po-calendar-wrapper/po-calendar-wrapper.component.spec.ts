...
describe('PoCalendarWrapperComponent', () => {
  ...
  describe('onComboBlur', () => {
    ...
    it('should call updateDisplay with safe values when comboComponent is provided and year/month are undefined', fakeAsync(() => {
      ...
      expect(updateDisplaySpy).toHaveBeenCalledWith(2027, 4);
    }));
    ...
    it('should fallback to today when comboComponent is provided and display values are undefined', fakeAsync(() => {
      ...
      expect(updateDisplaySpy).toHaveBeenCalledWith(2031, 9);
    }));
    ...
    it('should handle invalid month value (string) and restore from selectedOption', fakeAsync(() => {
      ...
      component.templateContext.monthIndex = 'invalid' as any;

      const mockComboComponent = {
        selectedOption: { value: 3, label: 'Março' },
        inputEl: { nativeElement: { value: 'invalid' } }
      };

      component.onComboBlur(mockComboComponent);
      tick(0);

      expect(mockComboComponent.inputEl.nativeElement.value).toBe('Março');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle invalid month value (NaN) and restore from selectedOption', fakeAsync(() => {
      ...
      const mockComboComponent = {
        ...
        inputEl: { nativeElement: { value: 'NaN' } }
      };

      component.onComboBlur(mockComboComponent);
      tick(0);

      expect(mockComboComponent.inputEl.nativeElement.value).toBe('Fevereiro');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle out-of-range month value and restore from selectedOption', fakeAsync(() => {
      ...
      component.displayMonthNumber = 5;
      component.templateContext.year = 2026;
      component.templateContext.monthIndex = 15;

      const mockComboComponent = {
        selectedOption: { value: 0, label: 'Janeiro' },
      ...
      expect(mockComboComponent.inputEl.nativeElement.value).toBe('Janeiro');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle invalid year value (string) and restore from selectedOption', fakeAsync(() => {
      ...
      const mockComboComponent = {
        selectedOption: { value: 2025, label: '2025' },
        inputEl: { nativeElement: { value: 'invalid' } }
      };
      ...
      expect(mockComboComponent.inputEl.nativeElement.value).toBe('2025');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle out-of-range year (below 1900) and restore from selectedOption', fakeAsync(() => {
      ...
      const mockComboComponent = {
        selectedOption: { value: 2020, label: '2020' },
        inputEl: { nativeElement: { value: '1800' } }
      };

      component.onComboBlur(mockComboComponent);
      tick(0);

      expect(mockComboComponent.inputEl.nativeElement.value).toBe('2020');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle out-of-range year (above 2100) and restore from selectedOption', fakeAsync(() => {
      ...
      const mockComboComponent = {
        selectedOption: { value: 2030, label: '2030' },
        inputEl: { nativeElement: { value: '2150' } }
      };

      component.onComboBlur(mockComboComponent);
      tick(0);

      expect(mockComboComponent.inputEl.nativeElement.value).toBe('2030');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should always restore selectedOption value on blur even with valid values', fakeAsync(() => {
      ...
      component.displayMonthNumber = 5;
      component.templateContext.year = 2026;
      component.templateContext.monthIndex = 7;

      const mockComboComponent = {
        selectedOption: { value: 5, label: 'Maio' },
        inputEl: { nativeElement: { value: 'Agosto' } }
      };

      component.onComboBlur(mockComboComponent);
      tick(0);

      expect(mockComboComponent.inputEl.nativeElement.value).toBe('Maio');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should handle complex invalid text like "teste0101" and restore from selectedOption', fakeAsync(() => {
      ...
      component.displayMonthNumber = 5;
      component.templateContext.year = 2026;
      component.templateContext.monthIndex = 'teste0101' as any;

      const mockComboComponent = {
        selectedOption: { value: 4, label: 'Maio' },
        inputEl: { nativeElement: { value: 'teste0101' } }
      };
    ...
    it('should use empty string when selectedOption.label is undefined', fakeAsync(() => {
      ...
      const mockComboComponent = {
        selectedOption: { value: 3, label: undefined },
        inputEl: { nativeElement: { value: 'invalid' } }
      };
      ...
      expect(mockComboComponent.inputEl.nativeElement.value).toBe('');
      expect(updateDisplaySpy).not.toHaveBeenCalled();
    }));
    ...
    it('should use currentYear when year is valid but month is invalid', fakeAsync(() => {
      ...
      expect(updateDisplaySpy).toHaveBeenCalledWith(2025, 5);
    }));
    ...
    it('should use currentMonth when month is valid but year is invalid', fakeAsync(() => {
      ...
      component.displayMonthNumber = 5;
      component.templateContext.year = undefined;
      component.templateContext.monthIndex = 3;
      ...
      expect(updateDisplaySpy).toHaveBeenCalledWith(2026, 3);
    }));
  });
  ...
  describe('onComboBlur', () => {
    ...
    beforeEach(() => {
      component = TestBed.createComponent(PoCalendarWrapperComponent).componentInstance;
      component.displayYear = 2030;
      component.displayMonthNumber = 10;
    ...
    describe('should use fallback values when year or month is invalid', () => {
      it('should use currentYear when year is valid but month is invalid', () => {
        component.templateContext = { year: 2025, monthIndex: null };
        component.onComboBlur();

        expect(component['updateDisplay']).toHaveBeenCalledWith(2025, 10);
      });

      it('should use currentMonth when month is valid but year is invalid', () => {
        component.templateContext = { year: undefined, monthIndex: 7 };
        component.onComboBlur();

        expect(component['updateDisplay']).toHaveBeenCalledWith(2030, 7);
      });
    });

    describe('should use fallback values when comboComponent is provided', () => {
      it('should use currentYear when year is valid but month is invalid', fakeAsync(() => {
        component.templateContext = { year: 2024, monthIndex: undefined };
        const mockComboComponent = {};
        component.onComboBlur(mockComboComponent);

        tick(0);

        expect(component['updateDisplay']).toHaveBeenCalledWith(2024, 10);
      }));

      it('should use currentMonth when month is valid but year is invalid', fakeAsync(() => {
        component.templateContext = { year: null, monthIndex: 3 };
        const mockComboComponent = {};
        component.onComboBlur(mockComboComponent);

        tick(0);

        expect(component['updateDisplay']).toHaveBeenCalledWith(2030, 3);
      }));
    });
  });
