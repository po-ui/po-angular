...
export class SamplePoGridBasicComponent {
  ...
  data = [
    { id: 629131, name: 'Jhony Senem', occupation: 'Developer', email: 'jhony.senem@portinari.com.br',
      status: 'Active', lastActivity: '2018-12-12', actions: '...' },
    { id: 78492341, name: 'Rafaelly Gruber', occupation: 'Engineer', email: 'rafaelly.gruber@portinari.com.br',
      status: 'Active', lastActivity: '2018-12-10', actions: '...' },
    { id: 986434, name: 'Nicole Oliveira', occupation: 'Developer', email: 'nicole.oliveira@portinari.com.br',
      status: 'Active', lastActivity: '2018-12-12', actions: '...' },
    { id: 4235652, name: 'Mateus José', occupation: 'Developer', email: 'mateus.jose@portinari.com.br',
      status: 'Active', lastActivity: '2018-11-23', actions: '...' },
    { id: 629131, name: 'Leonardo Leal', occupation: 'Engineer', email: 'leonardo.leal@portinari.com.br',
