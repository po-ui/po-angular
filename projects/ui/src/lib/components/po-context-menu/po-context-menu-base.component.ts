 ...
 * @description
 *
 * O componente `po-context-menu` é uma barra lateral de contexto (sidebar) para navegação interna de módulos.
 ...
 *
 * Evite o uso simultâneo dos componentes `po-menu` e `po-context-menu`.
 * Caso ambos sejam necessários na mesma interface, certifique-se de que não permaneçam expandidos simultaneamente
