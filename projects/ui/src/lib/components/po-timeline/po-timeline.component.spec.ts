...
describe('PoTimelineComponent', () => {
  ...
  let fixtureMock: ComponentFixture<PoTimeLineComponentMock>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [PoTimelineComponent, PoTimeLineComponentMock]
    })
      .compileComponents();
  }));
  ...
  beforeEach(() => {
    ...
    fixtureMock = TestBed.createComponent(PoTimeLineComponentMock);
  ...
  describe('Methods:', () => {
    ...
    it('Should call `cardSelect` with `card` and return undefined', () => {
      component.clickable = false;

      expect(component.cardSelect(card)).toEqual(undefined);
    })
