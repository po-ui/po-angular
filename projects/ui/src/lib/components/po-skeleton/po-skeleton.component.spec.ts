...
describe('PoSkeletonComponent', () => {
  ...
  it('should apply custom width style', () => {
    ...
    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
  ...
  it('should render sr-only element with default loading label', () => {
    fixture.componentRef.setInput('p-aria-label', 'Carregando');
    fixture.detectChanges();

    const srOnlyElement = nativeElement.querySelector('.po-skeleton-aria-label');
    expect(srOnlyElement).toBeTruthy();
    expect(srOnlyElement.textContent).toBe('Carregando');
    expect(srOnlyElement.getAttribute('role')).toBe('status');
    expect(srOnlyElement.getAttribute('aria-live')).toBe('polite');
  });

  it('should render sr-only element with custom loading label', () => {
    fixture.componentRef.setInput('p-aria-label', 'Carregando dados do usuário');
    fixture.detectChanges();

    const srOnlyElement = nativeElement.querySelector('.po-skeleton-aria-label');
    expect(srOnlyElement.textContent).toBe('Carregando dados do usuário');
  });

  it('should not render sr-only element when loading label is empty string', () => {
    fixture.componentRef.setInput('p-aria-label', '');
    fixture.detectChanges();

    const srOnlyElement = nativeElement.querySelector('.po-skeleton-aria-label');
    expect(srOnlyElement).toBeNull();
  });
  ...
  it('should apply default size for square variant', () => {
    ...
    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('48px');
    expect(skeletonElement.style.height).toBe('48px');
  });
  ...
  it('should apply lg size for rectangle variant', () => {
    ...
    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('192px');
  ...
  it('should apply xl size for square variant', () => {
    ...
    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('96px');
    expect(skeletonElement.style.height).toBe('96px');
  });

  it('should apply xs size for circle variant', () => {
    fixture.componentRef.setInput('p-variant', 'circle');
    fixture.componentRef.setInput('p-size', 'xs');
    fixture.detectChanges();

    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('24px');
    expect(skeletonElement.style.height).toBe('24px');
  });

  it('should apply 2xl size for circle variant', () => {
    fixture.componentRef.setInput('p-variant', 'circle');
    fixture.componentRef.setInput('p-size', '2xl');
    fixture.detectChanges();

    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('144px');
    expect(skeletonElement.style.height).toBe('144px');
  });

  it('should apply xs size for rectangle variant', () => {
    fixture.componentRef.setInput('p-variant', 'rectangle');
    fixture.componentRef.setInput('p-size', 'xs');
    fixture.detectChanges();

    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('72px');
    expect(skeletonElement.style.height).toBe('24px');
  });

  it('should apply 2xl size for rectangle variant', () => {
    fixture.componentRef.setInput('p-variant', 'rectangle');
    fixture.componentRef.setInput('p-size', '2xl');
    fixture.detectChanges();

    const skeletonElement = nativeElement.querySelector<HTMLElement>('.po-skeleton-wrapper');
    expect(skeletonElement.style.width).toBe('432px');
    expect(skeletonElement.style.height).toBe('144px');
  });

  it('should apply xs size for square variant', () => {
    fixture.componentRef.setInput('p-variant', 'square');
    fixture.componentRef.setInput('p-size', 'xs');
    fixture.detectChanges();
  ...
  it('should apply 2xl size for square variant', () => {
    fixture.componentRef.setInput('p-variant', 'square');
    fixture.componentRef.setInput('p-size', '2xl');
    fixture.detectChanges();
  ...
  describe('computedStyles:', () => {
    ...
    it('should return correct width and height for circle variant with xs size', () => {
      fixture.componentRef.setInput('p-variant', 'circle');
      fixture.componentRef.setInput('p-size', 'xs');
      fixture.detectChanges();
      const styles = component.computedStyles();
    ...
    it('should return correct width and height for circle variant with 2xl size', () => {
      fixture.componentRef.setInput('p-variant', 'circle');
      fixture.componentRef.setInput('p-size', '2xl');
      fixture.detectChanges();
      const styles = component.computedStyles();
      expect(styles['width']).toBe('144px');
    ...
    it('should return correct width and height for rectangle variant with xs size', () => {
      fixture.componentRef.setInput('p-variant', 'rectangle');
      fixture.componentRef.setInput('p-size', 'xs');
      fixture.detectChanges();
      const styles = component.computedStyles();
    ...
    it('should return correct width and height for rectangle variant with 2xl size', () => {
      fixture.componentRef.setInput('p-variant', 'rectangle');
      fixture.componentRef.setInput('p-size', '2xl');
      fixture.detectChanges();
      const styles = component.computedStyles();
      expect(styles['width']).toBe('432px');
      expect(styles['height']).toBe('144px');
    });
    ...
    it('should apply default border-radius 50% for circle variant', () => {
      fixture.componentRef.setInput('p-variant', 'circle');
      fixture.detectChanges();
      const styles = component.computedStyles();
