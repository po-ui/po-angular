...
describe('PoSkeletonComponent', () => {
  ...
  it('should render sr-only element with default loading label', () => {
    fixture.componentRef.setInput('p-loading-label', 'Carregando');
    fixture.detectChanges();

    const srOnlyElement = nativeElement.querySelector('.po-skeleton-loading-label');
  ...
  it('should render sr-only element with custom loading label', () => {
    fixture.componentRef.setInput('p-loading-label', 'Carregando dados do usuário');
    fixture.detectChanges();
  ...
  it('should not render sr-only element when loading label is empty string', () => {
    fixture.componentRef.setInput('p-loading-label', '');
    fixture.detectChanges();
