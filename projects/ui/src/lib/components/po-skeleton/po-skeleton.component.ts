...
export class PoSkeletonComponent extends PoSkeletonBaseComponent {
  ...
  > = {
    ...
    [PoSkeletonSize.md]: { square: 64, circle: 64, rectangleWidth: 192, rectangleHeight: 64 },
    [PoSkeletonSize.lg]: { square: 96, circle: 96, rectangleWidth: 288, rectangleHeight: 96 },
    [PoSkeletonSize.xl]: { square: 128, circle: 128, rectangleWidth: 384, rectangleHeight: 128 }
  };
