...
describe('PoButtonBaseComponent', () => {
  ...
  beforeEach(() => {
    ...
    // Mockando o localStorage para evitar vazamento global entre threads concorrentes do Vitest
  beforeEach(() => {
  ...
  afterEach(() => {
    vi.unstubAllGlobals();  // Restaura o localStorage global original
    document.documentElement.removeAttribute('data-a11y');
  });
  ...
  describe('p-size', () => {
    ...
    it('should return small when accessibility is AA and getA11yDefaultSize is small', () => {
      document.documentElement.setAttribute('data-a11y', PoThemeA11yEnum.AA);
      vi.spyOn(localStorage, 'getItem').mockReturnValue('small');
    ...
    it('should return medium when accessibility is AA and getA11yDefaultSize is medium', () => {
      document.documentElement.setAttribute('data-a11y', PoThemeA11yEnum.AA);
      vi.spyOn(localStorage, 'getItem').mockReturnValue('medium');
