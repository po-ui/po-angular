...
describe('PoHeaderComponent', () => {
  ...
  it('should call updateButtonMore if amountMore was changed', () => {
    vi.spyOn(component, 'updateButtonMore');
  ...
  it('should keep currentWidth when receiveOnChange$ emits and width <= 960', () => {
    vi.spyOn(component, 'handleLargeSreen');
    vi.spyOn(component, 'handleSmallSreen');
  ...
  it('should call detectChanges and handleSmallSreen when receiveRemovedApplicationMenu emits', async () => {
    vi.spyOn(component['cd'], 'detectChanges');
    vi.spyOn(component, 'handleSmallSreen');
  ...
  it('should call detectChanges and handleLargeSreen when receiveRemovedApplicationMenu emits', async () => {
    vi.spyOn(component['cd'], 'detectChanges');
    vi.spyOn(component, 'handleLargeSreen');
  ...
  it('should call detectChanges and handleLargeSreen when receiveRemovedApplicationMenu emits and notChangeContext is true', async () => {
    vi.spyOn(component['cd'], 'detectChanges');
    vi.spyOn(component, 'handleLargeSreen');
  ...
  it('should set applicationMenu to undefined when id is equal', async () => {
    vi.spyOn(component['cd'], 'detectChanges');
  ...
  it('should subscribe to window resize and call handleLargeSreen when width > 960', async () => {
    vi.spyOn(component, 'handleSmallSreen');
    vi.spyOn(component, 'handleLargeSreen');
  ...
  it('ngAfterViewInit: should subscribe to resize event and call updateMenu after debounce', async () => {
    const spyUpdateMenu = vi.spyOn<any, any>(component, 'updateMenu');
  ...
  it('should call toggleMenuMobile when existMenuExternal is true', () => {
    ...
    vi.spyOn(component.applicationMenu, 'toggleMenuMobile');
  ...
  it('should use document.documentElement.clientWidth when parent width is not available', () => {
    Object.defineProperty(document.documentElement, 'clientWidth', { get: () => 800, configurable: true });
