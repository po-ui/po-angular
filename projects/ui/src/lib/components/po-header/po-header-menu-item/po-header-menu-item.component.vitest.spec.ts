...
describe('PoHeaderMenuItemComponent', () => {
  ...
  it('ngOnInit: should subscribe to resize event and call checkActiveItemByUrl after debounce', async () => {
    const spyCheckFragments = vi.spyOn<any, any>(component, 'checkRouterChildrenFragments').mockReturnValue('/test');
    const spyCheckActive = vi.spyOn<any, any>(component, 'checkActiveItemByUrl');
  ...
  it('should call openListButtonMore when event is Space', () => {
    vi.spyOn(component, 'openListButtonMore');
  ...
  it('should open external link in new tab when isExternalLink is true', () => {
    ...
    vi.spyOn(util, 'isExternalLink').mockReturnValue(true);
  ...
  it('should navigate using router when isExternalLink is false', () => {
    ...
    vi.spyOn(util, 'isExternalLink').mockReturnValue(false);
  ...
  it('should stop at the first match and not continue looping', () => {
    ...
    const spy = vi.spyOn<any, any>(component, 'checkActiveItemByUrl');
