...
describe('PoHttpInterceptorBaseService', () => {
  ...
  it('should show success notification', inject(
    ...
    (http: HttpClient, httpMock: HttpTestingController) => {
      ...
      vi.spyOn(service.notification, 'success').mockImplementation(() => {});
  ...
  it('should not show invalid type notification', inject(
    ...
    (http: HttpClient, httpMock: HttpTestingController) => {
      ...
      vi.spyOn(mockNotification, 'success');
  ...
  it('should show error notification', inject(
    [HttpClient, HttpTestingController],
    (http: HttpClient, httpMock: HttpTestingController) => {
      vi.spyOn(service.notification, 'error').mockImplementation(() => {});
  ...
  it('should show warning notification', inject(
    [HttpClient, HttpTestingController],
    (http: HttpClient, httpMock: HttpTestingController) => {
      vi.spyOn(service.notification, 'warning').mockImplementation(() => {});
  ...
  it('should show information notification', inject(
    [HttpClient, HttpTestingController],
    (http: HttpClient, httpMock: HttpTestingController) => {
      vi.spyOn(service.notification, 'information').mockImplementation(() => {});
  ...
  it('should not show error notification', inject(
    [HttpClient, HttpTestingController],
    (http: HttpClient, httpMock: HttpTestingController) => {
      vi.spyOn(mockNotification, 'error');
  ...
  describe('Methods:', () => {
    ...
    it('createModal: should create instance of `PoHttpInterceptorDetail`, set detail, subscribe to closed, and call open.', () => {
      ...
      vi.spyOn(service['componentInjector'], 'createComponentInApplication').mockReturnValue(detailComponentFake);
      vi.spyOn(service as any, 'destroyModal').mockImplementation(() => {});
      vi.spyOn(detailComponentFake.instance, 'open' as any);
    ...
    it('destroyModal: should destroy detail component if httpInterceptorDetailComponent is defined', () => {
      ...
      vi.spyOn(service.componentInjector, 'destroyComponentInApplication').mockImplementation(() => {});
    ...
    it('generateDetailModal: should call createModal if modal isn`t created', () => {
      ...
      vi.spyOn(service as any, 'createModal').mockImplementation(() => {});
    ...
    it('processResponse: shouldn`t call showNotification if hasNoMessageParam is true', () => {
      vi.spyOn(service, 'hasNoMessageParam').mockReturnValue(true);
      vi.spyOn(service as any, 'showNotification').mockImplementation(() => {});
    ...
    it('processResponse: should call showNotification if hasNoMessageParam is false, body and _messages are true', () => {
      vi.spyOn(service, 'hasNoMessageParam').mockReturnValue(false);
      vi.spyOn(service as any, 'showNotification').mockImplementation(() => {});
    ...
    it('showNotification: shouldn`t call notification if no has message', () => {
      ...
      vi.spyOn(service.notification, 'information' as any).mockImplementation(() => {});
    ...
    it('showNotification: should call notification if has message', () => {
      ...
      vi.spyOn(service.notification, 'success' as any).mockImplementation(() => {});
