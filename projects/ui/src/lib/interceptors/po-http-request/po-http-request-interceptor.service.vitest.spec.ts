...
describe('PoHttpRequestInterceptorService: ', () => {
  ...
  describe('Methods: ', () => {
    ...
    it('intercept: should return `throwError` when call `catch` method.', inject(
      [HttpClient, HttpTestingController],
      (http: HttpClient, httpMock: HttpTestingController) => {
        vi.spyOn(httpRequestInterceptor as any, 'setCountPendingRequests' as any).mockImplementation(() => {});
        vi.spyOn(httpRequestInterceptor as any, 'setCountOverlayRequests' as any).mockImplementation(() => {});
    ...
    it(`requestCloneWithoutHeaderParam: should call 'headers.delete' when call
      ...
      vi.spyOn(requestWithHeaderParam.headers as any, 'delete' as any);
    ...
    it('buildLoading: should create `PoLoadingOverlayComponent` when `loadingOverlayComponent` is undefined.', () => {
      ...
      vi.spyOn(
        httpRequestInterceptor.poComponentInjector as any,
        'createComponentInApplication' as any
      ).mockReturnValue(componentRef);
    ...
    it(`destroyLoading: should destroy component when 'loadingOverlayComponent' is defined.`, () => {
      ...
      vi.spyOn(
        httpRequestInterceptor.poComponentInjector as any,
        'destroyComponentInApplication' as any
      ).mockImplementation(() => {});
