...
describe('PoControlPositionService:', () => {
  ...
  it('overflowAllSides: should call getOverflows()', () => {
    vi.spyOn(component as any, 'getOverflows' as any).mockImplementation(() => {});
  ...
  it('should call setTopPositions() in all top sides in setElementPosition()', () => {
    ...
    vi.spyOn(fakeThis as any, 'setTopPositions' as any);
  ...
  it('should call setRightPositions() in all right sides in setElementPosition()', () => {
    const fakeThis = getFakeSizesAndPositions(10, 10, 10, 10);
    vi.spyOn(fakeThis as any, 'setRightPositions' as any);
  ...
  it('should call setBottomPositions() in all bottom sides in setElementPosition()', () => {
    const fakeThis = getFakeSizesAndPositions(10, 10, 10, 10);
    vi.spyOn(fakeThis as any, 'setBottomPositions' as any);
  ...
  it('should call setLeftPositions() in all left sides in setElementPosition()', () => {
    const fakeThis = getFakeSizesAndPositions(10, 10, 10, 10);
    vi.spyOn(fakeThis as any, 'setLeftPositions' as any);
  ...
  it('should verify sub positions in verifySubPositions()', () => {
    ...
    vi.spyOn(fakeThis as any, 'elementPosition' as any);
    ...
    vi.spyOn(fakeThis as any, 'overflowAllSides' as any).mockReturnValue(true);
    vi.spyOn(fakeThis as any, 'nextPosition' as any);
    component['verifySubPositions'].call(fakeThis, 'top');
  ...
  describe('Methods:', () => {
    ...
    it('getMainPositions: should return [`top`, `right`] if `customPositions` is [´top´, ´top-right´, ´right´]', () => {
      ...
      vi.spyOn(component as any, 'getMainPositionsByCustomPositions' as any);
    ...
    describe('adjustPosition:', () => {
      it('should call `elementPosition` with value if has value', () => {
        const position = 'left';
        vi.spyOn(component as any, 'elementPosition' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'adjustDefaultPosition' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'adjustCustomPosition' as any).mockImplementation(() => {});
      ...
      it('should call `setElementPosition`, and `nextPosition` if `overflowMain` return true', () => {
        vi.spyOn(component as any, 'overflowMain' as any).mockReturnValue(true);
        vi.spyOn(component as any, 'setElementPosition' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'getMainPosition' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'nextPosition' as any).mockImplementation(() => {});
      ...
      it(`should call 'verifySubPositions' if 'overflowAllSides' return true and not call 'nextPosition' if 'overflowMain'
        return false`, () => {
        vi.spyOn(component as any, 'overflowMain' as any).mockReturnValue(false);
        vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(true);
        vi.spyOn(component as any, 'verifySubPositions' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'setElementPosition' as any).mockImplementation(() => {});
        vi.spyOn(component as any, 'nextPosition' as any).mockImplementation(() => {});
      ...
      return false`, () => {
        vi.spyOn(component as any, 'overflowMain' as any).mockReturnValue(false);
        vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(false);
        vi.spyOn(component as any, 'setElementPosition' as any).mockImplementation(() => {});
    ...
    it('adjustCustomPosition: should call `overflowAllSides` twice if `customPosition.length` is 2', () => {
      ...
      const overflowAllSides = vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(true);
      const nextPosition = vi.spyOn(component as any, 'nextPosition' as any).mockImplementation(() => {});
      const elementPosition = vi.spyOn(component as any, 'elementPosition' as any).mockImplementation(() => {});
    ...
    it('adjustCustomPosition: should not call `nextPosition` and `elementPosition` if `overflowAllSides` return false.', () => {
      component['customPositions'] = ['top', 'bottom'];
      const overflowAllSides = vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(false);
      const nextPosition = vi.spyOn(component as any, 'nextPosition' as any).mockImplementation(() => {});
      const elementPosition = vi.spyOn(component as any, 'elementPosition' as any).mockImplementation(() => {});
    ...
    it(`adjustDefaultPosition: should call 'getMainPosition' and 'verifySubPositions' if 'overflowMain' return false and 'overflowAllSides'
      return true.`, () => {
      const getMainPositions = vi.spyOn(component as any, 'getMainPositions' as any).mockReturnValue('bottom');
      const overflowMain = vi.spyOn(component as any, 'overflowMain' as any).mockReturnValue(false);
      const overflowAllSides = vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(true);
      const verifySubPositions = vi.spyOn(component as any, 'verifySubPositions' as any).mockImplementation(() => {});
      vi.spyOn(component as any, 'elementPosition' as any).mockImplementation(() => {});
    ...
    it(`adjustDefaultPosition: should return undefined if 'overflowMain' and 'overflowAllSides' return false.`, () => {
      const getMainPositions = vi.spyOn(component as any, 'getMainPositions' as any).mockReturnValue('left');
      const overflowMain = vi.spyOn(component as any, 'overflowMain' as any).mockReturnValue(false);
      const overflowAllSides = vi.spyOn(component as any, 'overflowAllSides' as any).mockReturnValue(false);
      const nextPosition = vi.spyOn(component as any, 'nextPosition' as any).mockImplementation(() => {});
      const verifySubPositions = vi.spyOn(component as any, 'verifySubPositions' as any).mockImplementation(() => {});
    ...
    it('elementPosition: should call `setAlignedElementPosition` if `isCornerAligned` is true.', () => {
      ...
      const setAlignedElementPosition = vi
        .spyOn(component as any, 'setAlignedElementPosition' as any)
        .mockImplementation(() => {});
    ...
    it('elementPosition: should call `setElementPosition` if `isCornerAligned` is false.', () => {
      ...
      const setElementPosition = vi.spyOn(component as any, 'setElementPosition' as any).mockImplementation(() => {});
      component['elementPosition']('bottom');
    ...
    describe('setAlignedElementPosition:', () => {
      it('should always call `setElementWidth` and `setAlignedArrowDirection`.', () => {
        const setElementWidth = vi.spyOn(component as any, 'setElementWidth' as any).mockImplementation(() => {});
        const setAlignedArrowDirection = vi
          .spyOn(component as any, 'setAlignedArrowDirection' as any)
          .mockImplementation(() => {});
        const getSizesAndPositions = vi
          .spyOn(component as any, 'getSizesAndPositions' as any)
          .mockImplementation(() => {});
      ...
      it('should call `setAlignedBottomPositions` if position is `bottom-left`.', () => {
        const setAlignedBottomPositions = vi
          .spyOn(component as any, 'setAlignedBottomPositions' as any)
          .mockImplementation(() => {});
        const getSizesAndPositions = vi
          .spyOn(component as any, 'getSizesAndPositions' as any)
          .mockImplementation(() => {});
      ...
      it('should call `setAlignedTopPositions` if position is `top-left`.', () => {
        const setAlignedTopPositions = vi
          .spyOn(component as any, 'setAlignedTopPositions' as any)
          .mockImplementation(() => {});
        const getSizesAndPositions = vi
          .spyOn(component as any, 'getSizesAndPositions' as any)
          .mockImplementation(() => {});
