...
describe('mergePoI18nConfigs', () => {
  ...
  describe('PoI18nService', () => {
    ...
    let languageServiceMock: {
      ...
      getShortLanguage: ReturnType<typeof vi.fn>;
      setLanguage: ReturnType<typeof vi.fn>;
      setLanguageDefault: ReturnType<typeof vi.fn>;
    };
    ...
    beforeEach(() => {
      ...
      languageServiceMock = {
        getLanguage: vi.fn(),
        getShortLanguage: vi.fn(),
        setLanguage: vi.fn(),
        setLanguageDefault: vi.fn()
      };
    });
    ...
    it('should call mergePoI18nConfigs when multiple configs are passed (Array)', () => {
      ...
      const service = new PoI18nService(configs, httpMock as any, languageServiceMock as any);
    ...
    it('should use config as-is when a single config object is passed', () => {
      ...
      const service = new PoI18nService(config, httpMock as any, languageServiceMock as any);
      const result = (service as any).varI18n;
