...
describe('PoI18nService:', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, LazyModule, PoLanguageModule, PoI18nModule.config(config)]
    });
  ...
  describe('Methods:', () => {
    ...
    it(`setConfig: shouldn't set 'languageDefault' if 'config.default' is undefined.`, () => {
      const configMock = {
        default: undefined
      };
...
describe('PoI18nService with Service', () => {
  ...
  describe('Methods: ', () => {
    ...
    it(`getLiteralsFromContextService: shouldn't call 'observer.next' with translations if translations keys length is 0
      and call 'getLiteralsLocalStorageAndCache'`, () => {
      const observer = { next: val => {} };
    ...
    it(`getLiteralsLocalStorageAndCache: should call 'searchInLocalStorage' and call 'observer.next' with
    ...
    it(`getLiteralsLocalStorageAndCache: should call 'getHttpService' and call 'observer.next' with
