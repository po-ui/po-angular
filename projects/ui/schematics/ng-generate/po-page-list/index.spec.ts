...
describe('po-page-list:', () => {
  ...
  it('should create <name> component', () => {
    ...
    const tree = runner.runSchematic('po-page-list', { ...componentOptions, name: componentName }, appTree);
  ...
  it('should create <name> component and <name> module', () => {
    ...
    const tree = runner.runSchematic('po-page-list', options, appTree);
  ...
  it('should generate component in path informed', () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    runner.runSchematic('po-page-list', options, appTree);
    ...
    const treePath = runner.runSchematic('po-page-list', optionsPath, appTree);
