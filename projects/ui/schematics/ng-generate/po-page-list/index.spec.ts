...
describe('po-page-list:', () => {
  ...
  describe('auto-detected style on a project using the current Angular convention:', () => {
    it('should create <name> component files without type suffix', async () => {
      ...
      const tree = await runner.runSchematic('po-page-list', { ...componentOptions, name: componentName }, appTree);
    ...
    it('should reference sibling files without type suffix in the component file', async () => {
      const tree = await runner.runSchematic('po-page-list', { ...componentOptions, name: 'customers' }, appTree);
    ...
    it('should generate stylesheet with `less` extension if style is `less`', async () => {
      ...
      const tree = await runner.runSchematic('po-page-list', options, appTree);
    ...
    it('should generate component in path informed', async () => {
      ...
      const treePath = await runner.runSchematic('po-page-list', optionsPath, appTree);
    ...
    it('should use the custom prefix when create component', async () => {
      const prefix = 'wms';
      const tree = await runner.runSchematic('po-page-list', { ...componentOptions, name: 'customers', prefix }, appTree);
