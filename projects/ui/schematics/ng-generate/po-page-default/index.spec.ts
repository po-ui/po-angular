...
describe('po-page-default:', () => {
  ...
  it('should create <name> component', () => {
    ...
    const tree = runner.runSchematic('po-page-default', { ...componentOptions, name: componentName }, appTree);
  ...
  it('should create <name> component and <name> module', () => {
    ...
    const tree = runner.runSchematic('po-page-default', options, appTree);
  ...
  it('should generate component in path informed', () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    runner.runSchematic('po-page-default', options, appTree);
    ...
    const treePath = runner.runSchematic('po-page-default', optionsPath, appTree);
