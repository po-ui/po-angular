...
describe('po-page-detail:', () => {
  ...
  it('should create <name> component', () => {
    ...
    const tree = runner.runSchematic('po-page-detail', { ...componentOptions, name: componentName }, appTree);
  ...
  it('should generate component in path informed', () => {
    ...
    const treePath = runner.runSchematic('po-page-detail', optionsPath, appTree);
