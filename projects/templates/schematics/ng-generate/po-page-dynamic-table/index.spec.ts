...
xdescribe('po-page-dynamic-table:', () => {
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematic('po-page-dynamic-table', options, appTree);
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematic('po-page-dynamic-table', options, appTree);
    ...
    const treePath = await runner.runSchematic('po-page-dynamic-table', optionsPath, appTree);
