...
xdescribe('po-page-job-scheduler:', () => {
  ...
  it('should create <name> component and <name> module', async () => {
    ...
    const tree = await runner.runSchematic('po-page-job-scheduler', options, appTree);
  ...
  it('should generate component in path informed', async () => {
    ...
    const options = { ...componentOptions, name: 'customers', createModule: true };
    await runner.runSchematic('po-page-job-scheduler', options, appTree);
    ...
    const treePath = await runner.runSchematic('po-page-job-scheduler', optionsPath, appTree);
