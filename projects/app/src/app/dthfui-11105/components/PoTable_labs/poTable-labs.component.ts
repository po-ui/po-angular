...
import { SamplePoTableLabsService } from 'projects/ui/src/lib/components/po-table/samples/sample-po-table-labs/sample-po-table-labs.service';

@Component({
  selector: 'dthfui-11105-po-table-labs',
  templateUrl: './poTable-labs.component.html',
  standalone: false
})
export class Dthfui11105PoTableLabsComponent implements OnInit {
  ...
  public readonly columnsOptions: Array<PoCheckboxGroupOption> = [
    ...
    { value: 'link', label: 'Link', fixed: true },
